...
namespace UnityEngine.XR.ARFoundation
{
    ...
    public class TouchManager : MonoBehaviour
    {
        ...
        public TouchGesturePayload CreateTouchGesturePayload(Interactable i, Touch touched)
        {
        ...
        public TouchGesturePayload CreateTouchGesturePayload(Interactable i, Vector2 angle, Touch t1, Touch t2)
        {
            TouchGesturePayload t = new TouchGesturePayload();
            t.interactable = i;
            t.rotation = angle;
